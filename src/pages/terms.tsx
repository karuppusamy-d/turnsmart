...
const Home = (): ReactElement => {
  return (
    <>
      {/* SEO */}
      <PageSeo
        title={`Terms & Conditions | ${siteMetadata.title}`}
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700 min-h-[80vh]">
        ...
        <div className="pt-6 pb-10 prose dark:prose-invert">
          <p>
            Karuppusamy built the turnsmart app as an Open Source app. This
            SERVICE is provided by Karuppusamy at no cost and is intended for
            use as is.
          </p>
          <p>
            Karuppusamy is committed to ensuring that the app is as useful and
          ...
          <p>
            The turnsmart app stores and processes personal data that you have
          ...
          <p>
            You should be aware that there are certain things that Karuppusamy
            ...
            but Karuppusamy cannot take responsibility for the app not working
          ...
          <p>
            Along the same lines, Karuppusamy cannot always take responsibility
            ...
            it on to avail the Service, Karuppusamy cannot accept
            responsibility.
          </p>
          <p>
            With respect to Karuppusamy’s responsibility for your use of the
            ...
            that we can make it available to you. Karuppusamy accepts no
          ...
          <p>These terms and conditions are effective as of 2022-02-06</p>
          <p>
